...
/**
 * DMTProgressHUD operation modes.
 */
typedef enum {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    DMTProgressHUDModeIndeterminate,
    /** Progress is shown using a DMTRoundProgressView. */
	DMTProgressHUDModeDeterminate,
} DMTProgressHUDMode;


/**
 * Defines callback methods for DMTProgressHUD delegates.
 */
@protocol DMTProgressHUDDelegate <NSObject>
 ...
 */
@interface DMTRoundProgressView : UIProgressView {
 ...
 * The DMTProgressHUD window spans over the entire space given to it by the initWithFrame constructor and catches all
 ...
 */
@interface DMTProgressHUD : UIView {
	
	DMTProgressHUDMode mode;
	...
	id<DMTProgressHUDDelegate> delegate;
	NSString *labelText;
...
/** 
 * DMTProgressHUD operation mode. Switches between indeterminate (DMTProgressHUDModeIndeterminate) and determinate
 * progress (DMTProgressHUDModeDeterminate). The default is DMTProgressHUDModeIndeterminate.
 */
@property (assign) DMTProgressHUDMode mode;

/** 
 * The HUD delegate object. If set the delegate will receive hudWasHidden callbacks when the HUD was hidden. The
 * delegate should conform to the DMTProgressHUDDelegate protocol and implement the hudWasHidden method. The delegate
 * object will not be retained.
 */
@property (assign) id<DMTProgressHUDDelegate> delegate;
